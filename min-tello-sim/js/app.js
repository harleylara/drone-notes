...
require([
    ...
    "init/edx_state",
    "python/vm",
    "python/simulation_proxy",
    "python/internal_code",
    "text!static/default.py",
], function (require, domready) {
    domready(function () {
        console.log("DOM is ready, initializing tello sim code...");
        ...
        $("#run").click(function () {
            ...
            try {
                ...
                if (e.args) {
                    ...
                    console.log(
                        "Non-Python exception thrown from call to python function!"
                    );
                    console.log(e);
                    editor.getSession().setAnnotations([
                        {
        ...
        beacons.push(viewer.createBeacon([7, -5, -5]));
        beacons.push(viewer.createBeacon([-4, 4, 0]));
        beacons.push(viewer.createBeacon([4, 0, 10]));
        beacons.push(viewer.createBeacon([-3, 10, 0]));
